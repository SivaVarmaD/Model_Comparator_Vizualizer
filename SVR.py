...
# Creating and fitting the Support Vector Regression model
svr = SVR(kernel='rbf')
svr.fit(X_train, y_train)

# Saving the model and scaler
with open('svr_model.pkl', 'wb') as file:
    pickle.dump({'model': svr, 'scaler': scaler}, file)

print("SVR model and scaler saved as 'svr_model.pkl'")
...
try:
    ...
    print("Error: The model file 'svr_model.pkl' was not found.")
