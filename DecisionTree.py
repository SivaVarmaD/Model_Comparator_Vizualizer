...
with open('decision_tree_model.pkl', 'wb') as file:
    pickle.dump({'model': decision_tree_regressor, 'scaler': scaler}, file)

print("Decision Tree model and scaler saved as 'decision_tree_model.pkl'")
...
try:
    ...
    print("Error: The model file 'decision_tree_model.pkl' was not found.")
